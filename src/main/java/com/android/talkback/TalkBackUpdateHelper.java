...
public class TalkBackUpdateHelper {
    public static final String KICKBACK_PACKAGE = "com.xinyang.screenreader.kickback";
    public static final String SOUNDBACK_PACKAGE = "com.xinyang.screenreader.soundback";
