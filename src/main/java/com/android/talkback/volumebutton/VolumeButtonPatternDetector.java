...
public class VolumeButtonPatternDetector {
    ...
    public static final int LONG_PRESS_PATTERN = 4;
    ...
    public VolumeButtonPatternDetector() {
        ...
        mPatternMatchers.add(new SingleVolumeButtonLongPressPatternMatcher(VOLUME_UP));
        mPatternMatchers.add(new SingleVolumeButtonLongPressPatternMatcher(VOLUME_DOWN));
    }
