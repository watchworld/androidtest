...
public class AccessibilityEventProcessor {
     ...
     */
    public static final long EVENT_PROCESSING_DELAY = 50;
...
private int iSpeakWhenScreenOff = 0; // 0 speak, 1 screen on speak, 2 unspeak
...
//    }
    ...
    public void setSpeakWhenScreenOff(int speak) {
        iSpeakWhenScreenOff = speak;
    }
...
// and when iSpeakWhenScreenOff == 2 , not speak
        if (isNotification && (mIsUserTouchExploring || isPhoneActive  || iSpeakWhenScreenOff == 2)) {
            if (LogUtils.LOG_LEVEL <= Log.VERBOSE) {
